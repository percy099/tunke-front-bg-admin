...
<div class="body">
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
					...
					<div class="col-sm-6">
                        <a href="#deletePrestamoModal" class="btn btn-info" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Eliminar</span></a>
                        <a href="#editPrestamoModal" class="btn btn-info" data-toggle="modal"><i class="material-icons">&#xE3C9;</i> <span>Editar</span></a>                        
						<a href="#addPrestamoModal" class="btn btn-info" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Crear</span></a>						
					</div>
                </div>
            </div>
	...
	<!-- Edit Modal HTML -->
	<div id="editPrestamoModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form>
					<div class="modal-header">						
	...
	<!-- Delete Modal HTML -->
	<div id="deletePrestamoModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form>
					<div class="modal-header">						
