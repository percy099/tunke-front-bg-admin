...
<div class="body">
    <div class="container">
        <h2 class = "mb-4 mt-4">Transacciones Cuenta Dólares</h2>
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover" id="mydatatable">
                ...
                <tbody>
                    <tr v-for="(transaction,index) in transactionsDollar"  v-bind:key="index"><!--TODO-->
						<td>{{index + 1}}</td>
...
export default {
    ...
    computed:{
        ...mapState(['token','transactionsDollar'])
	},
	mounted(){
